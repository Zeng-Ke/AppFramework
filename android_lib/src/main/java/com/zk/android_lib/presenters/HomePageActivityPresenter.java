...
public class HomePageActivityPresenter extends UnbinderPresenter<HomePageActivityPresenter.IndexView> {
    ...
    public void getPhoneInfo(String phoneNumber) {
        ...
        firstService.getPhoneInfo(phoneNumber, "JQ4iONjs1LBg60Ghgj842cKvjgVE7dDRXfBpxsvWTrgP16hY5RtOaVgqy1Wky7MT",
                new AsyncCallBacker<BaseBean<List<PhoneInfoBean>>>(this) {
                    @Override
    ...
    public void getData() {
        FirstService firstService = new FirstService();
        firstService.getJob(new AsyncCallBacker<CommonDataBean<DoubleListBean>>(this) {
            @Override
    ...
    public void getJob() {
        ...
        firstService
                .getJob(
                        ...
                        , new AsyncCallBacker<String>(this) {
                            @Override
    ...
    public void getData1() {
        ...
        firstService
                ...
                .subscribe(firstService.getCallBacker(new AsyncCallBacker<String>(this) {
                    @Override
                    public void onCallBack(String s) {
